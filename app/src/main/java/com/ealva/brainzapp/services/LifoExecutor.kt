...
fun LifecycleOwner.lifoSingleThreadExecutor(): ThreadPoolExecutor {
  return ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, object : BlockingQueue<Runnable> {
    private val backingQueue: BlockingQueue<Pair> = PriorityBlockingQueue(1024) { arg1, arg2 ->
