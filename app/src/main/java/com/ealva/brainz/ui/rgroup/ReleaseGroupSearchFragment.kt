...
package com.ealva.brainz.ui.rgroup
...
class ReleaseGroupSearchFragment private constructor(
  private val brainz: MusicBrainzService,
  private val navigation: Navigation
) : Fragment() {
  private lateinit var uiContext: FragmentUiContext
  private lateinit var ui: ReleaseGroupSearchUi
  ...
  override fun onCreateView(
    ...
    ui = ReleaseGroupSearchUi.make(uiContext, brainz, navigation)
    return ui.root
  }

  companion object {
    val NAME: String = ReleaseGroupSearchFragment::class.java.name

    fun make(
      brainz: MusicBrainzService,
      navigation: Navigation
    ): ReleaseGroupSearchFragment {
      return ReleaseGroupSearchFragment(
        brainz,
        navigation
      )
    }

    fun make(fm: FragmentManager): ReleaseGroupSearchFragment {
